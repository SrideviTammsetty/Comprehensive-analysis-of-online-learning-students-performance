...
use online_education_db;
SELECT COUNT(DISTINCT id_student) AS total_studentsFROM online_education_dataset;
SELECT COUNT(DISTINCT id_student) AS total_studentsFROM onl_educat
SELECT COUNT(DISTINCT id_student) AS total_studentsFROM online_education_dataset;
SELECT ROUND(AVG(avg_score), 2) AS average_student_scoreFROM online_education_dataset;
SELECT COUNT(DISTINCT id_student) AS total_students FROM online_education_db;
